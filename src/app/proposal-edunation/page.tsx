  ...
  return (
    <section className="bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* Active Participation Section hanya untuk bahasa Arab */}
        {language === 'ar' && (
          <div className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-800 mb-4 relative inline-block">
              ...
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden transform transition-transform duration-300 hover:-translate-y-2">
                ...
                <div className="flex">
                  ...
                  <div className="flex-1 h-48 overflow-hidden -ml-1">
                    <img src="/edunation/active_participation_right.png" alt="Active Participation Right" className="w-full h-full object-contain scale-125" />
                  </div>
                </div>
                <div className="p-6">
