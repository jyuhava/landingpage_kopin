...
export default function Navbar() {
  ...
  // Function to get the appropriate registration link based on language
  const getRegistrationLink = () => {
    return language === 'ar' 
      ? "https://docs.google.com/forms/d/e/1FAIpQLSf0uHIWlUnXnyyDzWosi6mxasm6wqLcTeNuW77CO_6Qrp116g/viewform"
      : "https://docs.google.com/forms/d/e/1FAIpQLSf-9KQmex5Lzoda2asfK8g2vlmBlzO4s23aHskE9jVa6uilWA/viewform";
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center text-sm">
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-xs hidden sm:inline">{t('navbar.topBar.eventInfo')}</span>
        ...
        <div className="flex justify-between h-20">
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-3">
              ...
              />
              <div>
                <div className="text-2xl font-bold text-green-600">{t('navbar.logo.title')}</div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="#benefits" className="text-gray-700 hover:text-green-600 transition-colors font-medium">
              {t('navbar.menu.benefits')}
            </Link>
            <Link href="#edunation" className="text-gray-700 hover:text-green-600 transition-colors font-medium">
              {t('navbar.menu.edunation')}
            </Link>
            <div className="relative group">
              <Link href="#agenda" className="text-gray-700 hover:text-green-600 transition-colors font-medium flex items-center">
                {t('navbar.menu.agenda')}
                <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </Link>
              <div className="absolute top-full left-0 mt-2 w-48 bg-white shadow-lg rounded-lg py-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none group-hover:pointer-events-auto">
                <Link href="#fgd1-previous" className="block px-4 py-2 text-gray-700 hover:bg-green-50 hover:text-green-600">
                  {t('navbar.submenu.fgd1')}
                </Link>
                <Link href="#fgd_1" className="block px-4 py-2 text-gray-700 hover:bg-green-50 hover:text-green-600">
                  {t('navbar.submenu.fgd2')}
                </Link>
                <Link href="#fgd_3" className="block px-4 py-2 text-gray-700 hover:bg-green-50 hover:text-green-600">
            ...
            <a
              ...
              target="_blank"
              className="bg-green-600 text-white px-6 py-3 rounded-full hover:bg-green-700 transition-colors font-semibold shadow-lg hover:shadow-xl"
            >
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
              <Link href="#about" className="block px-3 py-3 text-gray-700 hover:text-green-600 hover:bg-green-50 rounded-lg transition-colors">
                {t('navbar.menu.about')}
              </Link>
