...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-20 bg-gradient-to-br from-emerald-50 via-white to-teal-50 overflow-hidden">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center p-2 bg-emerald-100 rounded-full mb-6">
            <div className="flex items-center space-x-2 px-4 py-2 bg-white rounded-full shadow-sm">
              ...
              <span className="text-emerald-700 font-medium text-sm">{t('about.badge')}</span>
            </div>
          </div>
            ...
            <div className="space-y-6">
              <div className="group">
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow">
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-2xl p-4 shadow-2xl">
                {aboutImage ? (
                  ...
                  <div className="w-full h-80 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      <div className="animate-pulse w-16 h-16 bg-emerald-200 rounded-full mx-auto mb-4"></div>
              ...
              <div className="absolute -top-6 -left-6 w-12 h-12 border-4 border-emerald-300 rounded-full opacity-60"></div>
              <div className="absolute -bottom-6 -right-6 w-16 h-16 border-4 border-teal-300 rounded-full opacity-60"></div>
              <div className="absolute top-1/2 -right-8 w-8 h-8 bg-emerald-400 rounded-full opacity-40 transform -translate-y-1/2"></div>
              <div className="absolute top-1/4 -left-4 w-6 h-6 bg-teal-400 rounded-full opacity-50"></div>
            </div>
          </div>
        </div>
      </div>
