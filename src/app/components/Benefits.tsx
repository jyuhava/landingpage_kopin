...
export default function Benefits() {
  ...
  return (
    <section id="benefits" className="relative py-20 bg-gradient-to-br from-slate-50 via-emerald-50/20 to-teal-50/20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center p-2 bg-emerald-100 rounded-full mb-6">
            <div className="flex items-center space-x-2 px-4 py-2 bg-white rounded-full shadow-sm">
              ...
              <span className="text-emerald-700 font-medium text-sm">{t('benefits.badge')}</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {benefits.map((benefit, index) => (
            <div 
              key={index} 
              className="group relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 p-8 border border-white/20 hover:-translate-y-2 overflow-hidden"
            >
              ...
              <div className="relative mb-6">
                <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r ${benefit.gradient} rounded-2xl shadow-lg group-hover:shadow-xl transition-all duration-500 group-hover:scale-105`}>
              ...
              <div className="max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                  <a
                    ...
                    className="group inline-flex items-center px-8 py-4 bg-white text-emerald-600 rounded-full font-semibold hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                  >
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full p-3 flex items-center justify-center">
                      <img 
                    ...
                    <div className="text-left">
                      <div className="text-white font-semibold text-base">{t('benefits.cta.logoText.name')}</div>
                      <div className="text-white/80 text-sm">{t('benefits.cta.logoText.established')}</div>
